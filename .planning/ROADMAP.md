...
- [x] **Phase 1: Environment Separation** - Bot starts in Docker by eliminating Windows-specific paths (completed 2026-09-18)
...
- [x] 01-01-PLAN.md — Create .env.docker and update docker-compose.yml to use it
